...
*/
class enspire.interactivity.control.DropdownController 
	implements IActivity {
		
	private var evaluator:DropdownEvaluator;
	private var activityArgs:Object;
	private var activityProfile:Object;
	private var activityDisplay:DropdownDisplay;
	
	
	public function DropdownController() {
		evaluator = new DropdownEvaluator();
	}
	...
	public function setupActivityDisplay(clip:MovieClip):Void {
		activityDisplay = new DropdownDisplay();
	...
	public function evaluateActivity():IEvaluation {
		evaluator.setCurrentSequence(activityDisplay.getDropdowns());
