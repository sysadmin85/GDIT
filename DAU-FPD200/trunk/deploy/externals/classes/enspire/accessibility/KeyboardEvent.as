...
class enspire.accessibility.KeyboardEvent extends Event {
	...
	public function KeyboardEvent( type:String, inSource:Object,  keyCode:Number, charCode:Number, shiftKey:Boolean, ctrlKey:Boolean ) {
		super(type, inSource);
